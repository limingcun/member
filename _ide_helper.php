 ...
 * Generated for Laravel 5.5.32 on 2018-11-22.
 *
...
namespace App\Facades { 
    ...
    class IQueryClass {
        ...
        {
            return \App\Utils\IQuery::initRedis($conn);
        }
        ...
        {
            return \App\Utils\IQuery::redisGet($key);
        }
         ...
         * @static 
         */ 
        public static function redisSet($key, $val, $time = 0)
        {
            return \App\Utils\IQuery::redisSet($key, $val, $time);
        }
        ...
        {
            return \App\Utils\IQuery::redisExpire($key, $time);
        }
        ...
        {
            return \App\Utils\IQuery::redisDelete($key);
        }
         ...
         * @static 
         */ 
        public static function md5Check($request)
        {
            return \App\Utils\IQuery::md5Check($request);
        }
        ...
        {
            return \App\Utils\IQuery::getExcel($request);
        }
         ...
         * @static 
         */ 
        public static function loadExcel($excel, $filename, $export)
        {
            return \App\Utils\IQuery::loadExcel($excel, $filename, $export);
        }
        ...
        {
            return \App\Utils\IQuery::strPad($id);
        }
        ...
        {
            return \App\Utils\IQuery::createCode($length);
        }
         ...
         * @static 
         */ 
        public static function get_char($num, $flag = false)
        {
            return \App\Utils\IQuery::get_char($num, $flag);
        }
         ...
         * @static 
         */ 
        public static function miniTime()
        {
            return \App\Utils\IQuery::miniTime();
        }
        ...
        {
            return \App\Utils\IQuery::createNo();
        }
         ...
         * @static 
         */ 
        public static function send_post($url, $post_data, $method = 'POST')
        {
            return \App\Utils\IQuery::send_post($url, $post_data, $method);
        }
        ...
        {
            return \App\Utils\IQuery::api_notice_increment($url, $data);
        }
        ...
        {
            return \App\Utils\IQuery::filterEmoji($text, $replaceTo);
        }
         ...
         * @static 
         */ 
        public static function memberNoCreate($id, $n)
        {
            return \App\Utils\IQuery::memberNoCreate($id, $n);
        }
...
namespace Latrell\Lock\Facades { 
    ...
    class Lock {
        ...
        public static function store($name = null)
        {
            return \Latrell\Lock\LockManager::store($name);
        }
        ...
        public static function driver($driver = null)
        {
            return \Latrell\Lock\LockManager::driver($driver);
        }
        ...
        public static function getDefaultDriver()
        {
            return \Latrell\Lock\LockManager::getDefaultDriver();
        }
        ...
        public static function setDefaultDriver($name)
        {
            \Latrell\Lock\LockManager::setDefaultDriver($name);
        }
        ...
        public static function extend($driver, $callback)
        {
            return \Latrell\Lock\LockManager::extend($driver, $callback);
        }
...
namespace  { 
    ...
    class IQuery extends \App\Facades\IQueryClass {}
    ...
    class Lock extends \Latrell\Lock\Facades\Lock {}
